          ...
          <div className="relative mx-auto flex max-w-sm items-center justify-between">
            ...
            <div className="mx-auto my-2 flex w-fit justify-center gap-2">
              <div className="bg-muted relative z-20 rounded-2xl border p-1">
                <IntegrationCard
                  className="shadow-black-950/10 dark:bg-background size-16 border-black/25 shadow-xl dark:border-white/25 dark:shadow-white/10 text-accent-foreground"
                  isCenter={true}
                >
                  <MCP />
                </IntegrationCard>
