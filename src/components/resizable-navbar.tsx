  ...
  return (
    <motion.div
      ...
      className={cn(
        ...
        visible && "bg-background/80 backdrop-blur-md border border-border/50",
        className,
      )}
    >
      {children}
  ...
  return (
    ...
    >
      <img
        ...
        height={30}
      />
      <span className="font-medium text-foreground">Dukkecord</span>
    </a>
  );
};
...
export const NavbarButton = ({
  ...
  const variantStyles = {
    ...
    dark: "bg-foreground text-background shadow-lg hover:bg-foreground/90",
    gradient:
