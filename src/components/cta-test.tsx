    ...
    <section id="cta">
      <div className="py-14">
        <div className="flex w-full flex-col items-center justify-center p-4">
          <div className="relative flex w-full max-w-6xl flex-col items-center justify-center overflow-hidden rounded-[2rem]">
            ...
            <div className="absolute z-10">
              ...
              <div className="z-10 mt-4 flex flex-col items-center text-center text-primary break-all">
